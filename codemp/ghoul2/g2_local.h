...
qboolean G2_SetSurfaceOnOff(const CGhoul2Info* ghlInfo, surfaceInfo_v& slist, const char* surface_name, int off_flags);
...
qboolean G2_Set_Bone_Angles(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name, const float* angles,
	int flags, Eorientations up, Eorientations left, Eorientations forward,
	int blend_time, int current_time);
qboolean G2_Remove_Bone(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name);
qboolean G2_Set_Bone_Anim(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name, int startFrame,
	int endFrame, int flags, float anim_speed, int current_time, float set_frame, int blend_time);
qboolean G2_Get_Bone_Anim(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name, int current_time,
	float* current_frame, int* startFrame, int* endFrame, int* flags, float* ret_anim_speed);
qboolean G2_Get_Bone_Anim_Range(const CGhoul2Info* ghlInfo, const boneInfo_v& blist, const char* bone_name,
	int* startFrame, int* endFrame);
qboolean G2_Pause_Bone_Anim(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* bone_name, int current_time);
...
qboolean G2_Set_Bone_Anim_Index(boneInfo_v& blist, int index, int startFrame, int endFrame, int flags, float anim_speed,
	int current_time, float set_frame, int ablend_time, int num_frames);
qboolean G2_Get_Bone_Anim_Index(boneInfo_v& blist, int index, int current_time, float* current_frame, int* startFrame,
	int* endFrame, int* flags, float* ret_anim_speed, int num_frames);
...
int G2_Add_Bolt_Surf_Num(const CGhoul2Info* ghlInfo, boltInfo_v& bltlist, const surfaceInfo_v& slist, int surf_num);
...
int G2API_InitGhoul2Model(CGhoul2Info_v** ghoul2Ptr, const char* fileName, int model_index, const qhandle_t customSkin = NULL_HANDLE, const qhandle_t customShader = NULL_HANDLE, int modelFlags = 0, const int lodBias = 0);
...
qboolean G2API_SetShader(CGhoul2Info* ghlInfo, const qhandle_t custom_shader);
...
qboolean G2API_SetBoneAnim(CGhoul2Info_v& ghoul2, const int model_index, const char* boneName, const int astart_frame, const int aend_frame, const int flags, const float animSpeed, const int current_time, const float aset_frame = -1, const int blend_time = -1);
qboolean G2API_GetBoneAnim(CGhoul2Info_v& ghoul2, const int model_index, const char* boneName, const int current_time, float* current_frame, int* startFrame, int* endFrame, int* flags, float* animSpeed, int* model_list);
...
qboolean G2API_StopBoneAnim(CGhoul2Info* ghlInfo, const char* bone_name);

qboolean G2API_SetBoneAngles(CGhoul2Info_v& ghoul2, const int model_index, const char* boneName, const vec3_t angles, const int flags, const Eorientations up, const Eorientations left, const Eorientations forward, qhandle_t* model_list, const int blend_time, const int current_time);

qboolean G2API_StopBoneAngles(CGhoul2Info* ghlInfo, const char* bone_name);
...
qboolean G2API_GetBoltMatrix(CGhoul2Info_v& ghoul2, const int model_index, const int bolt_index, mdxaBone_t* matrix, const vec3_t angles, const vec3_t position, const int frameNum, qhandle_t* model_list, vec3_t scale);
...
qboolean G2API_SetBoneAnglesMatrix(CGhoul2Info* ghlInfo, const char* boneName, const mdxaBone_t& matrix, const int flags, const qhandle_t* model_list, const int blend_time = 0, const int current_time = 0);
...
qboolean G2API_SetBoneAnglesMatrixIndex(CGhoul2Info* ghlInfo, const int index, const mdxaBone_t& matrix, const int flags, qhandle_t* model_list, const int blend_time, const int current_time);
qboolean G2API_DoesBoneExist(CGhoul2Info_v& ghoul2, const int model_index, const char* boneName);
qboolean G2API_SetBoneAnimIndex(CGhoul2Info* ghlInfo, const int index, const int astart_frame, const int aend_frame, const int flags, const float anim_speed, const int acurrent_time, const float aset_frame, const int blend_time);
